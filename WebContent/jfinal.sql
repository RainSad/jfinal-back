...
CREATE TABLE `sys_area` (
  ...
  `level` int(8) DEFAULT NULL COMMENT '级数',
...
INSERT INTO `sys_area` VALUES ('4104', '520115', '小河区', '2496', '小河', '', '', '3', '12', '2');
...
CREATE TABLE `sys_department` (
  ...
  `type` varchar(2) DEFAULT NULL COMMENT '类型 1公司  2公司领导 3部门  0其它',
...
-- ----------------------------
INSERT INTO `sys_department` VALUES ('1', '湖北万维科技发展有限责任公司', '武汉', null, '1', null, null, '2016-12-16 22:06:03');
INSERT INTO `sys_department` VALUES ('2', '戴鹰', '武汉', null, '2', '1', null, '2016-12-18 18:23:37');
INSERT INTO `sys_department` VALUES ('3', '研发部', '武汉', null, '3', '1', null, '2016-12-13 18:23:39');
INSERT INTO `sys_department` VALUES ('4', '质检部', '武汉', null, '3', '1', null, '2016-12-15 18:23:42');
...
CREATE TABLE `sys_dictionary` (
  ...
  `status` varchar(2) DEFAULT '1' COMMENT '状态 1可用 0禁用',
  `remark` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `sys_dictionary` VALUES ('1', 'app类型管理', '', null, 'sys_app_type', '1', 'app类型管理');
INSERT INTO `sys_dictionary` VALUES ('2', '安卓', '1', '1', '', '1', null);
INSERT INTO `sys_dictionary` VALUES ('3', '苹果', '2', '1', '', '1', null);
INSERT INTO `sys_dictionary` VALUES ('4', '其它', '3', '1', '', '1', null);
INSERT INTO `sys_dictionary` VALUES ('5', '状态管理', '', null, 'sys_status', '1', '状态管理');
INSERT INTO `sys_dictionary` VALUES ('6', '正常', '1', '5', '', '1', null);
INSERT INTO `sys_dictionary` VALUES ('7', '禁用', '0', '5', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('8', '部门类型管理', null, null, 'sys_dept_type', '1', '部门类型管理');
INSERT INTO `sys_dictionary` VALUES ('9', '公司', '1', '8', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('10', '公司领导', '2', '8', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('11', '部门', '3', '8', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('12', '其它', '0', '8', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('13', '资源类型管理', null, null, 'sys_resources_type', '1', '资源类型管理');
INSERT INTO `sys_dictionary` VALUES ('14', '菜单', '1', '13', null, '1', null);
INSERT INTO `sys_dictionary` VALUES ('15', '权限', '2', '13', null, '1', null);
...
CREATE TABLE `sys_log` (
  ...
  `opt_user` varchar(32) DEFAULT NULL COMMENT '用户名',
  `realname` varchar(32) DEFAULT NULL COMMENT '用户姓名',
  `is_success` varchar(2) DEFAULT NULL COMMENT '是否成功 1是 0否',
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1', '192.168.1.100', 'Windows', 'Chrome', 'admin', '管理员', '1', '{\"password\":[\"******\"]}', '/sys_user/updatePassword', '2016-12-17 15:15:37', '用户登录');
INSERT INTO `sys_log` VALUES ('2', '192.168.1.100', 'Windows', 'Chrome', 'admin', '管理员', '0', '{\"newPassword\":[\"12\"],\"password\":[\"******\"]}', '/sys_user/updatePassword', '2016-12-17 15:15:46', '用户登录发生异常:/ by zero');
...
CREATE TABLE `sys_resources` (
  ...
  `sort` int(8) DEFAULT NULL COMMENT '排序',
  `type` varchar(20) DEFAULT NULL COMMENT '1菜单 2 权限 ',
  `status` varchar(2) DEFAULT '1' COMMENT '1可用 0禁用',
  `remark` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `sys_resources` VALUES ('1', '系统管理', '', null, null, 'icon-standard-cog', '1', '0', '1', '1', '系统管理', '2016-12-09 11:33:39');
INSERT INTO `sys_resources` VALUES ('2', '系统数据', '', null, null, 'icon-hamburg-graphic', '1', '0', '1', '1', '系统监控', '2016-12-15 11:33:43');
INSERT INTO `sys_resources` VALUES ('3', '用户管理', '/sys_user/main', '1', null, 'icon-hamburg-user', '2', '1', '1', '1', null, '2016-12-23 11:33:47');
INSERT INTO `sys_resources` VALUES ('4', '角色管理', '/sys_role/main', '1', null, 'icon-hamburg-my-account', '2', '2', '1', '1', null, '2016-12-08 11:33:50');
INSERT INTO `sys_resources` VALUES ('5', '资源管理', '/sys_resources/main', '1', null, 'icon-berlin-9', '2', '3', '1', '1', null, '2016-11-28 11:34:25');
INSERT INTO `sys_resources` VALUES ('6', '机构管理', '/sys_dept/main', '1', null, 'icon-cologne-home', '2', '4', '1', '1', null, '2016-12-06 11:33:56');
INSERT INTO `sys_resources` VALUES ('7', '日志管理', '/sys_log/main', '2', null, 'icon-ext-log', '2', '2', '1', '1', null, '2016-12-12 11:34:21');
INSERT INTO `sys_resources` VALUES ('8', '数据监控', '/druid/index.html', '2', null, 'icon-cologne-database', '2', '4', '1', '1', null, '2016-11-30 11:34:16');
INSERT INTO `sys_resources` VALUES ('9', '区域信息', '/sys_area/main', '2', null, 'icon-metro-globe', '2', '3', '1', '1', null, '2016-12-15 11:34:11');
INSERT INTO `sys_resources` VALUES ('12', '字典管理', '/sys_dictionary/main', '2', null, 'icon-metro-book', '2', '1', '1', '1', '字典管理', '2016-12-19 11:34:00');
INSERT INTO `sys_resources` VALUES ('13', '用户添加', '', '3', 'sys:user:create', 'icon-add', '3', '1', '2', '1', '添加用户的权限', '2016-12-19 19:29:58');
INSERT INTO `sys_resources` VALUES ('14', '用户删除', '', '3', 'sys:user:delete', 'icon-remove', '3', '2', '2', '1', '删除用户的权限', '2016-12-19 19:30:01');
INSERT INTO `sys_resources` VALUES ('15', '用户修改', '', '3', 'sys:user:update', 'icon-edit', '3', '3', '2', '1', '修改用户的权限', '2016-12-19 19:30:04');
INSERT INTO `sys_resources` VALUES ('16', '用户查询', '', '3', 'sys:user:list', 'icon-search', '3', '4', '2', '1', '查看用户的权限', '2016-12-19 19:30:07');
INSERT INTO `sys_resources` VALUES ('17', '用户角色', '', '3', 'sys:user:getRole', 'icon-hamburg-my-account', '3', '5', '2', '1', null, '2016-12-19 23:18:50');
INSERT INTO `sys_resources` VALUES ('19', '角色添加', null, '4', 'sys:role:create', 'icon-add', '3', '1', '2', '1', null, '2016-12-20 09:34:10');
INSERT INTO `sys_resources` VALUES ('20', '角色修改', null, '4', 'sys:role:update', 'icon-edit', '3', '2', '2', '1', null, '2016-12-20 09:34:10');
INSERT INTO `sys_resources` VALUES ('21', '角色删除', null, '4', 'sys:role:delete', 'icon-remove', '3', '3', '2', '1', null, '2016-12-20 09:34:10');
INSERT INTO `sys_resources` VALUES ('22', '角色查询', null, '4', 'sys:role:list', 'icon-search', '3', '4', '2', '1', null, '2016-12-20 09:34:10');
INSERT INTO `sys_resources` VALUES ('23', '角色权限分配', '', '4', 'sys:role:saveResource', 'icon-metro-lock', '3', '5', '2', '1', null, '2016-12-20 09:40:19');
INSERT INTO `sys_resources` VALUES ('24', '资源添加', null, '5', 'sys:resources:create', 'icon-add', '3', '1', '2', '1', null, '2016-12-20 09:41:04');
INSERT INTO `sys_resources` VALUES ('25', '资源修改', null, '5', 'sys:resources:update', 'icon-edit', '3', '2', '2', '1', null, '2016-12-20 09:41:04');
INSERT INTO `sys_resources` VALUES ('26', '资源删除', null, '5', 'sys:resources:delete', 'icon-remove', '3', '3', '2', '1', null, '2016-12-20 09:41:04');
INSERT INTO `sys_resources` VALUES ('27', '资源查询', null, '5', 'sys:resources:list', 'icon-search', '3', '4', '2', '1', null, '2016-12-20 09:41:04');
INSERT INTO `sys_resources` VALUES ('28', '添加基本权限', '', '5', 'sys:resources:saveBasePermission', 'icon-add', '3', '5', '2', '1', null, '2016-12-20 09:43:08');
INSERT INTO `sys_resources` VALUES ('29', '部门添加', null, '6', 'sys:dept:create', 'icon-add', '3', '1', '2', '1', null, '2016-12-20 09:43:26');
INSERT INTO `sys_resources` VALUES ('30', '部门修改', null, '6', 'sys:dept:update', 'icon-edit', '3', '2', '2', '1', null, '2016-12-20 09:43:26');
INSERT INTO `sys_resources` VALUES ('31', '部门删除', null, '6', 'sys:dept:delete', 'icon-remove', '3', '3', '2', '1', null, '2016-12-20 09:43:26');
INSERT INTO `sys_resources` VALUES ('32', '部门查询', null, '6', 'sys:dept:list', 'icon-search', '3', '4', '2', '1', null, '2016-12-20 09:43:26');
INSERT INTO `sys_resources` VALUES ('33', '日志删除', null, '7', 'sys:log:delete', 'icon-remove', '3', '3', '2', '1', null, '2016-12-20 09:45:14');
INSERT INTO `sys_resources` VALUES ('34', '日志查询', null, '7', 'sys:log:list', 'icon-search', '3', '4', '2', '1', null, '2016-12-20 09:45:14');
INSERT INTO `sys_resources` VALUES ('35', '导出日志', '', '7', 'sys:log:exportExcel', 'icon-standard-page-excel', '3', '5', '2', '1', null, '2016-12-20 09:47:32');
INSERT INTO `sys_resources` VALUES ('36', '字典添加', '', '12', 'sys:dict:create', 'icon-add', '3', '1', '2', '1', null, '2016-12-20 09:49:14');
INSERT INTO `sys_resources` VALUES ('37', '字典修改', '', '12', 'sys:dict:update', 'icon-edit', '3', '2', '2', '1', null, '2016-12-20 09:50:23');
INSERT INTO `sys_resources` VALUES ('38', '字典删除', '', '12', 'sys:dict:delete', 'icon-remove', '3', '3', '2', '1', null, '2016-12-20 09:50:26');
INSERT INTO `sys_resources` VALUES ('39', '字典查询', '', '12', 'sys:dict:list', 'icon-search', '3', '4', '2', '1', null, '2016-12-20 09:50:29');
...
CREATE TABLE `sys_role` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '插件时间',
  `status` varchar(2) DEFAULT '1' COMMENT '状态 1可用 0禁用',
  `remark` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '管理员', 'admin', '2016-12-13 10:45:50', '1', '管理员');
INSERT INTO `sys_role` VALUES ('2', '测试员', 'test', '2016-12-15 18:39:34', '1', '测试员');
...
INSERT INTO `sys_role_resources` VALUES ('1', '25');
...
CREATE TABLE `sys_user` (
  ...
  `geneder` varchar(2) DEFAULT NULL COMMENT '性别 0不详 1男  2女',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '管理员', null, 'c57e73d9c04e5fc9a3bf836611f2890a', '123', null, null, null, '2016-12-08 10:19:32', null, '1', '管理员');
INSERT INTO `sys_user` VALUES ('2', 'test', '测试员', null, 'd492500b0332a07bc5ca4d6443996861', null, null, null, null, '2016-12-15 14:35:48', null, '1', null);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `v_user_role_resource` AS SELECT sur.user_id,sur.role_id, sr.id,sr.`level`,sr.`name`,sr.parent_id,sr.perm_code,sr.remark,sr.sort,sr.`status` ,
sr.type,sr.url,sr.create_time,ifnull(sr.iconCls,'icon-hamburg-right') iconCls
from sys_user_role sur
LEFT JOIN sys_role_resources srr on sur.role_id=srr.role_id
LEFT JOIN sys_resources sr on srr.resources_id=sr.id 
