$(function(){
	...
	function changeTheme(themeName){
		var t=$('#theme');
		t.attr("href",$u.getRootPath()+"/plugins/jquery-easyui-theme/"+themeName+"/easyui.css");
	    ...
	    if ($iframe.length > 0) {
	        for ( var i = 0; i < $iframe.length; i++) {
	           var ifr = $iframe[i];
	           $(ifr).contents().find('#theme').attr('href', $u.getRootPath()+"/plugins/jquery-easyui-theme/"+themeName+"/easyui.css");
	        }
	    }
