...
public class Conditions {
    ...
    public static void main(String[] args) {
    	...
    	user.setStatus("1");
    	condi.setValueQuery(Conditions.GREATER_EQUAL, "inputTime", "2016"); //开始时间
    	condi.setValueQuery(Conditions.LESS_EQUAL, "inputTime", "2015"); //结束时间
    	condi.setFiledQuery(Conditions.FUZZY, "username","realname");
